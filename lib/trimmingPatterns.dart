...
class TrimPat extends StatefulWidget {
  const TrimPat({super.key});
   
  @override
  State<TrimPat> createState() => _TrimPatState();
}

class _TrimPatState extends State<TrimPat> {
